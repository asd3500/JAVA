...
final public class Constants {
    ...
    public static final String INCORRECT_AGE_VALUE_MESSAGE = "Incorrect age value";
    public static final String REGISTER_SUCCESSFUL_MESSAGE = "Registration successful";
